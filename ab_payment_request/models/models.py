...
class PaymentRequest(models.Model):
    ...
    def unlink(self):
        ...
        # seakan-akan a,b,c + d. artinya harus menggunakan super pada overriding method di model
    ...
    def _amount_settlement(self):
        for o in self:
            o.update({"settlement_total": sum([l.amount for l in o.settlement_line])})

    @api.depends("settlement_total", "amount_total", "amount_aap")
    def _amount_diff(self):
        for o in self:
            o.update({"amount_diff": o.amount_aap - (o.settlement_total + o.amount_total)})
...
# function ini berguna untuk versi sebelumnya namun untuk sekarang dapat mengoverride di bagian
